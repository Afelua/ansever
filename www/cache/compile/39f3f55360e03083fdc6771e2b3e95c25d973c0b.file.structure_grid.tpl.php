<?php /* Smarty version Smarty-3.0.8, created on 2015-03-13 04:36:27
         compiled from "Z:/home/sever-arenda/www/apps/system/template/structure_grid.tpl" */ ?>
<?php /*%%SmartyHeaderCode:235035501f8cbe87337-72269639%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '39f3f55360e03083fdc6771e2b3e95c25d973c0b' => 
    array (
      0 => 'Z:/home/sever-arenda/www/apps/system/template/structure_grid.tpl',
      1 => 1424158306,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '235035501f8cbe87337-72269639',
  'function' => 
  array (
  ),
...
$(document).ready(function(){
	...
	/*$('#topic_tree').tree({
		...
		dnd: true,
		url: "<?php echo $_smarty_tpl->getVariable('estate_folder')->value;?>
/js/ajax.php?action=topic_source",
		onDrop: function(target, source, point){
			...
			if(ids.length>0){
				$.ajax({
					url: '<?php echo $_smarty_tpl->getVariable('estate_folder')->value;?>
/js/ajax.php?action=save_topic_sort',
...
/apps/system/js/easyui/default/easyui.css">
<script type="text/javascript" src="<?php echo $_smarty_tpl->getVariable('estate_folder')->value;?>
/apps/system/js/easyui/jquery.easyui.min.js"></script>
