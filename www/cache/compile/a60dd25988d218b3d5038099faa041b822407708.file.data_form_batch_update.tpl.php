<?php /* Smarty version Smarty-3.0.8, created on 2015-04-23 00:56:32
         compiled from "Z:/home/anseverv2/www/apps/admin/admin/template/data_form_batch_update.tpl" */ ?>
<?php /*%%SmartyHeaderCode:220505537d2c0a42ef3-66137998%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a60dd25988d218b3d5038099faa041b822407708' => 
    array (
      0 => 'Z:/home/anseverv2/www/apps/admin/admin/template/data_form_batch_update.tpl',
      1 => 1424158272,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '220505537d2c0a42ef3-66137998',
  'function' => 
  array (
  ),
...
/apps/system/js/geodata.js"></script> -->
...
">
			<label class="control-label"><input type="checkbox" name="batch_update[<?php echo $_smarty_tpl->tpl_vars['element']->value['name'];?>
]" value="1"<?php if (isset($_smarty_tpl->getVariable('selected_fields',null,true,false)->value[$_smarty_tpl->tpl_vars['element']->value['name']])){?> checked="checked"<?php }?> /> <?php echo $_smarty_tpl->tpl_vars['element']->value['title'];?>
...
">
						<div class="form_element_title">
							<input type="checkbox" name="batch_update[<?php echo $_smarty_tpl->tpl_vars['element']->value['name'];?>
]" value="1"<?php if (isset($_smarty_tpl->getVariable('selected_fields',null,true,false)->value[$_smarty_tpl->tpl_vars['element']->value['name']])){?> checked="checked"<?php }?> /> 
